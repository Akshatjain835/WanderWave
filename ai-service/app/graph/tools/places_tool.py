...
# Comprehensive Real-World Destination Database
DESTINATION_KNOWLEDGE_BASE: Dict[str, List[Dict[str, Any]]] = {
    ...
    "jaipur": [
        ...
        {"name": "Nahargarh Fort Sunset Point", "category": "Viewpoint / Sunset", "best_time": "Evening", "estimated_cost_per_person": 150.0, "description": "Cliffside fort on Aravalli hills offering sweeping evening views over the illuminated Pink City."},
    ...
    "goa": [
        ...
        {"name": "Fort Aguada & Lighthouse", "category": "Heritage / Viewpoint", "best_time": "Morning", "estimated_cost_per_person": 100.0, "description": "17th-century Portuguese fort standing at the mouth of Mandovi River with a historic lighthouse."},
        ...
        {"name": "Fontainhas Latin Quarter Walking Tour", "category": "Culture / Photography", "best_time": "Afternoon", "estimated_cost_per_person": 300.0, "description": "Charming heritage quarter with brightly painted Portuguese houses, terracotta roofs, and cafes."}
    ],
    "manali": [
...
def fetch_live_wikipedia_attractions(city_name: str) -> List[Dict[str, Any]]:
    ...
    """
    try:
        url = f"https://en.wikipedia.org/w/api.php?action=opensearch&search=Tourist_attractions_in_{city_name}&limit=8&format=json"
...
def get_places_and_attractions(destination: str, interests: List[str], travel_style: str) -> List[Dict[str, Any]]:
    ...
    Uses:
    1. Static Knowledge Base (for instant offline accuracy)
    ...
    if live_places and len(live_places) >= 4:
        return live_places
